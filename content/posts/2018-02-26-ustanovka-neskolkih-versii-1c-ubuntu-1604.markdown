...
tags: [1c,linux]
description: В статье описан способ установки нескольких различных версий 1С в Ubuntu Linux 16.04
---

В статье приведён сценарий для установки множественных версий 1С:Предприятие в Ubuntu Linux (от 16.04).
